        ...
        <div class="text-center mt-4">
            <h3 class="text-2xl font-bold">
                <a href="/hall/book/{{ $books[0]->slug }}"
                    class="text-gray-900 hover:text-blue-500 capitalize">
                    {{ $books[0]->name }}
                </a>
            </h3>
            ...
            <div class="flex justify-center items-center text-gray-600 text-sm gap-4 mt-2">
                ...
                <span class="flex items-center gap-1">
                    ...
                    <a href="/hall/category/{{ $books[0]->category->name }}" class="hover:text-blue-500">{{ $books[0]->category->name }}</a>
                </span>
                <span class="flex items-center gap-1">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    <h5 class="text-lg font-bold">
                        <a href="/hall/book/{{ $book->slug }}" class="hover:text-blue-500">{{ $book->name }}</a>
                    </h5>
